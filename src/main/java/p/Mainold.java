...
import static p.Mainold.Buttons.*;
import static p.Sudoku.*;
public class Mainold extends JFrame implements /*Printable,*/ActionListener {
    enum Buttons {
        Print,Postscript,Image,Left,Right,Number,Style,Colors;
    }
    // make a pdf
    // use circle, with number
    public Mainold(Cli myOptions,java.util.List<Sudoku> sudokus) {
